    ...
    this.subscription = inkdrop.commands.add(document.body, {
	  ...
	  'todotxt:enableDelete': () => {
		...
		menu = inkdrop.menu.add([
			{
			label: 'Plugins',
			submenu : [{label: 'todotxt', submenu : [{label: 'Disable deleting completed' , command: 'todotxt:disableDelete'}]}]
			}
		]);
	  ...
	  'todotxt:disableDelete': () => {
		...
		menu = inkdrop.menu.add([
			{
			label: 'Plugins',
			submenu : [{label: 'todotxt', submenu : [{label: 'Enable deleting completed' , command: 'todotxt:enableDelete'}]}]
			}
		]);
